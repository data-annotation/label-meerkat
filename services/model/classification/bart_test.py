...
def load_from_pretrained(model_path: str = 'facebook/bart-base', num_labels: int = 2):
...
def predict(data, model_path='test_model', num_label = 2, device='cpu'):
...
if __name__ == "__main__":
    ...
    model_path = train(data, labels, label_list=['positive', 'negative'])
